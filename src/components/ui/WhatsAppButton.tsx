...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-24 h-24 md:w-28 md:h-28 bg-transparent text-[#25D366] hover:text-[#128C7E] hover:scale-110 transition-all duration-300 group"
      aria-label="Chat with us on WhatsApp"
    >
      <MessageCircle className="w-16 h-16 md:w-20 md:h-20 drop-shadow-lg" />
